 ...
 */
public class MyScheduleAdapter2 extends RecyclerView.Adapter<MyScheduleAdapter2.UpcomingScheduleCardViewHolder> {
    ...
    public MyScheduleAdapter2(List<Schedules> schedulesList, Activity activity)
    {
